          ...
          <ul class="sidebar-menu">
            ...
            <li class="active treeview">
              ...
              <ul class="treeview-menu">
                ...
                <li class="active"><a href="pengembalian"><i class="fa fa-circle-o"></i> Pengembalian Mobil</a></li>
              </ul>
            </li>
            <li class="treeview">
              <a href="#">
                  ...
                  <table id="example2" class="table table-bordered table-hover" style="background:#ECF0F5">
                    ...
                    @foreach($pinjaman as $pinjaman)
                      <tr>
                        ...
                        <td>
                        @if($pinjaman->status_pengambilan=="Diambil" )
                        <div class="btn-group">
                          <a class="btn btn-default" href="{{ url('edpengembalian/'.$pinjaman->id) }}">
                            <i class="fa fa-arrow-right"></i>
                          </a>
                          @endif
                          <div class="btn-group">
                          <a class="btn btn-default" onclick="return confirm('Yakin Hapus?')" href="{{ url('pengembalian/delete/'.$pinjaman->id) }}">
                            <i class="fa fa-trash-o"></i>
                          </a>
                          <div class="btn-group">
                          <a class="btn btn-default" href="{{ url('pdfkembali/'.$pinjaman->id) }}">
