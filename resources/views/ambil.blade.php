                  ...
                  <table id="example2" class="table table-bordered table-hover" style="background:#ECF0F5">
                    ...
                    @foreach($pinjaman as $pinjaman)
                      <tr>
                        ...
                        <td>
                        @if($pinjaman->status=="lunas" && $pinjaman->status_pengambilan=="belum diambil")
                        <div class="btn-group">
                          <a class="btn btn-default" href="{{ url('edambil/'.$pinjaman->id) }}">
                            <i class="fa fa-arrow-right"></i>
                          </a>
                        </div>
                        @endif
                          <div class="btn-group">
                          <a class="btn btn-default" onclick="return confirm('Yakin Hapus?')" href="{{ url('ambil/delete/'.$pinjaman->id) }}">
                            <i class="fa fa-trash-o"></i>
                          </a>
                          <div class="btn-group">
                          <a class="btn btn-default" href="{{ url('pdfambil/'.$pinjaman->id) }}">
