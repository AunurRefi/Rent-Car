            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header" style="background:white">
                  ...
                  <a href="/tambah"><button style="float:right;border:none;background:#82BA00;height:30px;width:150px;color:white" type="submit">Tambah Data</button></a>
                </div><!-- /.box-header -->
                  ...
                  <table id="example2" class="table table-bordered table-hover" style="background:#ECF0F5">
                    ...
                    @foreach($pinjaman as $pinjaman)
                      <tr>
                        ...
                        <td>
                        @if($pinjaman->status_pengambilan=="belum diambil")
                        <div class="btn-group">
                          <a class="btn btn-default" href="{{ url('edpinjaman/'.$pinjaman->id) }}">
                            <i class="fa fa-arrow-right"></i>
                          </a>
                          @endif
                          <div class="btn-group">
                          <a class="btn btn-default" onclick="return confirm('Yakin Hapus?')" href="{{ url('pinjaman/delete/'.$pinjaman->id) }}">
                            <i class="fa fa-trash-o"></i>
                          </a>
                          <div class="btn-group">
                          <a class="btn btn-default" href="{{ url('pdf/'.$pinjaman->id) }}">
