...
<html>
  ...
  <div class="content"> 
    <table style="width:30%">      
        <form action="merkinput" method="post">
        <input type="hidden" name="_token" value="<?php echo csrf_token(); ?>">
              <div class="control-group ">
              <div class="row">
              <div class="col-md-2">
              <label style="margin-top:20px;" for="lastname" class="control-label">Nama Vendor</label>
              </div>
      ...
      <div class="form-actions">
                                    ...
                                    <a href="/merek"><button style="margin-top:20px;" class="btn" type="button">Cancel</button></a>
                                </div>   
