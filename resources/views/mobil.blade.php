      ...
      <div class="content-wrapper">
        ...
        <section class="content">
          <div class="row">
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header" style="background:#withe">
                  <h3 style="color:white;" class="box-title">List</h3>
                  <a href="/inmobil"><button style="float:right;border:none;background:#82BA00;height:30px;width:150px;color:white" type="submit">Tambah Data</button></a>
                </div><!-- /.box-header -->
                    ...
                    @foreach($mobil as $mobil)
                      <tr>
                        ...
                        <td><div class="btn-group">
                          <a class="btn btn-default" href="{{ url('edmobil/'.$mobil->id) }}">
                            <i class="fa fa-arrow-right"></i>
                          </a>
                          <div class="btn-group">
                          <a class="btn btn-default" onclick="return confirm('Yakin Hapus?')" href="{{ url('mobil/delete/'.$mobil->id) }}">
